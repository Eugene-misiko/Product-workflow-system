...
from .views import DeliveryViewSet,update_issue_status,admin_issue_list,delivery_list_template, create_delivery, update_delivery_status, track_delivery, report_delivery_issue
...
urlpatterns += [
    ...
    path("admin/issues/",admin_issue_list, name="admin_issue_list"),
    path("admin/issues/<int:issue_id>/update/", update_issue_status, name="update_issue_status")
