...
from .views import OrderViewSet,orders_list, order_detail, order_create,order_approve,order_reject,move_to_delivery,move_to_design,move_to_printing,confirm_delivery,delete_order ,choose_delivery_mode,confirm_arrival,report_delivery_issue,products_by_category
...
urlpatterns += [
    ...
    path("view/orders/<int:order_id>/", order_detail, name="order_detail"),
