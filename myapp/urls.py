...
from .views import CategoryViewSet, ProductViewSet,product_detail, product_list, DynamicOrderViewSet
...
router = DefaultRouter()
router.register(r'Item_orders', DynamicOrderViewSet, basename='Item_orders')
urlpatterns = router.urls
urlpatterns += [
